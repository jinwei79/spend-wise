...
class GroqService
{
    ...
    public function getExpenseCategory($description)
    {
        ...
        $response = $this->chatWithGroq('Based on the following categories: ' . json_encode($categories) . ', please suggest a category for the following expense: '. $description .'. Please return id only, if theres no category, please return 0');
