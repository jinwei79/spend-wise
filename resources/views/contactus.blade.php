<x-app-layout>
        ...
        <!-- Hardcoded Contact Us Section -->
        <div class="mt-12 max-w-7xl mx-auto sm:px-6 lg:px-8 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
            ...
            <form action="" method="POST" class="mt-4">
                ...
                <div class="mb-4">
                    ...
                    <!-- Automatically fill in Full Name from authenticated user -->
            ...
            @if($_SERVER['REQUEST_METHOD'] === 'POST')
                ...
                <!-- You can now process the form (e.g., send an email, store data in the database) -->
                @php
